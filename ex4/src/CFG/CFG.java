	...
	public void liveness() {
		...
		while (curr != null) {
			...
			if (isTwo) {
				...
				if (curr.inFunc) {
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_Two_Temps) curr.line).dst.getSerialNumber())));
			...
			if (curr.line.getClass().toString().equals("class IR.IRcommand_Store_Global")) {
				...
				if (curr.inFunc) {
					curr.FuncScope
							.add(("Temp_" + (((IRcommand_Store_Global) curr.line).dst.getSerialNumber())));
				}
			}
			if (curr.line.getClass().toString().equals("class IR.IRcommand_ThisDotField")) {
				if (!((IRcommand_ThisDotField) curr.line).cfg) {
					...
					if (curr.inFunc)
						curr.FuncScope
								.add(("Temp_" + (((IRcommand_ThisDotField) curr.line).dst.getSerialNumber())));
				} else {
					curr.inSet.remove(("Temp_" + (((IRcommand_ThisDotField) curr.line).dst.getSerialNumber())));
					if (curr.inFunc)
						curr.FuncScope
								.remove(("Temp_" + (((IRcommand_ThisDotField) curr.line).dst.getSerialNumber())));
				}
			}
			...
			if (curr.line.getClass().toString().equals("class IR.IRcommand_virtual_call")) {
				...
				curr.inSet
						.add(("Temp_" + (((IRcommand_virtual_call) curr.line).classTemp.getSerialNumber())));
				TEMP h;
				...
				if (curr.inFunc) {
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_virtual_call) curr.line).dst.getSerialNumber())));
					curr.FuncScope
							.add(("Temp_" + (((IRcommand_virtual_call) curr.line).classTemp.getSerialNumber())));
			...
			if (curr.line.IRname.equals("IRcommand_Conditional_Jump")) {
				if ((curr.line.getClass().toString().equals("class IR.IRcommand_Jump_bnez"))
					...
					curr.inSet
							.add(("Temp_" + (((IRcommand_Conditional_Jump) curr.line).oprnd1.getSerialNumber())));
					if (curr.inFunc) {
						curr.FuncScope
								.add(("Temp_" + (((IRcommand_Conditional_Jump) curr.line).oprnd1.getSerialNumber())));
					}
					...
					curr.inSet
							.add(("Temp_" + (((IRcommand_Conditional_Jump) curr.line).oprnd1.getSerialNumber())));
					curr.inSet
							.add(("Temp_" + (((IRcommand_Conditional_Jump) curr.line).oprnd2.getSerialNumber())));
					if (curr.inFunc) {
						curr.FuncScope
								.add(("Temp_" + (((IRcommand_Conditional_Jump) curr.line).oprnd1.getSerialNumber())));
						curr.FuncScope
			...
			if (curr.line.getClass().toString().equals("class IR.IRcommand_Array_Access")) {
				...
				if (curr.inFunc) {
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_Array_Access) curr.line).dst.getSerialNumber())));
			...
			if (curr.line.getClass().toString().equals("class IR.IRcommand_Load_Local")) {
				...
				if (curr.inFunc) {
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_Load_Local) curr.line).dst.getSerialNumber())));
				}
			}
			if (curr.line.getClass().toString().equals("class IR.IRcommand_store_field")) {
				...
				if (curr.inFunc)
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_store_field) curr.line).val.getSerialNumber())));
			}
			if (curr.line.getClass().toString().equals("class IR.IRcommand_Field_Access")) {
				...
				if (curr.inFunc) {
					curr.FuncScope
							.remove(("Temp_" + (((IRcommand_Field_Access) curr.line).dst.getSerialNumber())));
					curr.FuncScope
							.add(("Temp_" + (((IRcommand_Field_Access) curr.line).src.getSerialNumber())));
				}
			}
		...
		while (t != null) {
			...
			if (h.getClass().toString().equals("class IR.IRcommand_Store_Local")) {
				if (!((IRcommand_Store_Local) h).src.changed) {
					String theNum = IRtoMIPS
							.get(("Temp_" + (((IRcommand_Store_Local) h).src.getSerialNumber())));
					if (theNum == null) {
						theNum = IRtoMIPS.get("dead");
					}
			...
			if (h.IRname.equals("class IR.IRcommand_Conditional_Jump")) {
				if ((h.getClass().toString().equals("class IR.IRcommand_Jump_bnez"))
					...
					if (!((IRcommand_Conditional_Jump) h).oprnd1.changed) {
						String theNum = IRtoMIPS
								.get(("Temp_" + (((IRcommand_Conditional_Jump) h).oprnd1.getSerialNumber())));
						if (theNum == null) {
							theNum = IRtoMIPS.get("dead");
						}
					...
					if (!((IRcommand_Conditional_Jump) h).oprnd2.changed) {
						theNum = IRtoMIPS
								.get(("Temp_" + (((IRcommand_Conditional_Jump) h).oprnd2.getSerialNumber())));
						if (theNum == null) {
							theNum = IRtoMIPS.get("dead");
						}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_Load_Local")) {
				if (!((IRcommand_Load_Local) h).dst.changed) {
					String theNum = IRtoMIPS
							.get(("Temp_" + (((IRcommand_Load_Local) h).dst.getSerialNumber())));
					if (theNum == null) {
						theNum = IRtoMIPS.get("dead");
					}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_store_field")) {
				if (!((IRcommand_store_field) h).val.changed) {
					String theNum = IRtoMIPS
							.get(("Temp_" + (((IRcommand_store_field) h).val.getSerialNumber())));
					if (theNum == null) {
						theNum = IRtoMIPS.get("dead");
					}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_Return")) {
				if (((IRcommand_Return) h).RetVal != null) {
					if (!((IRcommand_Return) h).RetVal.changed) {
						String theNum = IRtoMIPS
								.get(("Temp_" + (((IRcommand_Return) h).RetVal.getSerialNumber())));
						if (theNum == null) {
							theNum = IRtoMIPS.get("dead");
						}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_Store_Global")) {
				if (!((IRcommand_Store_Global) h).dst.changed) {
					String theNum = IRtoMIPS
							.get(("Temp_" + (((IRcommand_Store_Global) h).dst.getSerialNumber())));
					if (theNum == null) {
						theNum = IRtoMIPS.get("dead");
					}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_ThisDotField")) {
				if (!((IRcommand_ThisDotField) h).dst.changed) {
					String theNum = IRtoMIPS
							.get(("Temp_" + (((IRcommand_ThisDotField) h).dst.getSerialNumber())));
					if (theNum == null) {
						theNum = IRtoMIPS.get("dead");
					}
			...
			if (h.getClass().toString().equals("class IR.IRcommand_virtual_call")) {
				...
				if (!((IRcommand_virtual_call) h).dst.changed) {
					theNum = this.IRtoMIPS
							.get(("Temp_" + (((IRcommand_virtual_call) h).dst.getSerialNumber())));
					if (theNum == null) {
						theNum = this.IRtoMIPS.get("dead");
					}
				...
				if (!((IRcommand_virtual_call) h).classTemp.changed) {
					theNum = this.IRtoMIPS
							.get(("Temp_" + (((IRcommand_virtual_call) h).classTemp.getSerialNumber())));
					if (theNum == null) {
						theNum = this.IRtoMIPS.get("dead");
					}
