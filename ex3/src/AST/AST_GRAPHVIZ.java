...
public class AST_GRAPHVIZ {
    ...
    public void logNode(int nodeSerialNumber, String nodeName,String shape) {
        fileWriter.format(
                "v%d [label = \"%s\" shape = %s];\n",
                nodeSerialNumber,
                nodeName,
    ...
    public void logNode(int nodeSerialNumber, String nodeName,String shape, String color) {
        fileWriter.format(
                "v%d [label = \"%s\" shape = %s color = %s];\n",
                nodeSerialNumber,
                nodeName,
                shape,
                color);
